...
\***Edit**: I discovered I could legally scrape the website from the _robots meta tags_ nested in the `<head>` tag of each HTML page:
```html
<html lang="en">
  <head>
...
`<index>` -- The spider [of a search engine] will now index your whole website;

`<follow>` -- The spider will not only index the first web-page of your website but also all your other web-pages.
