def clean(street_features, postcode_features, query_library):
    '''
    ...
    Input
    --------------------------------------------------------------------------
    street_features: defaultdict, required argument. A set of problematic
                     street names.
    postcode_features: defaultdict, required argument. A set of problematic
                       postal codes.
    query_library: list of _sre.SRE_Pattern(s), required argument. A list of
                   compiled regular expressions.

    * All arguments output of the function 'audit.py'.
    ...
    return better_name, better_postcode
