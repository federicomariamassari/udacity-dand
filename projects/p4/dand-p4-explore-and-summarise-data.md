...
As expected, African countries all locate in the third quadrant, an area in which a small share of GDP to services—Africa has the smallest median share among all continents (Table 2)—is associated to few contributions to the list. Apart from Norway, for which investment in the tertiary sector appears to be less significant, Western European countries all place in quadrants I & IV.
